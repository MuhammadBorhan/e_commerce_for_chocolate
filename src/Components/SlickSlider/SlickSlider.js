        ...
        {giftboxproduct?.map((data, index) => (
          <div className="card cards h-[200px] lg:h-[290px] bg- " key={index}>
            <div className="card-top">
              ...
              />
              <h1 className="text-sm lg:text-xl text-center bg-[#9A583B]  text-white font-bold py-1 uppercase">
                {data?.name}
              </h1>
            </div>
            <div className="bg-neutral">
              ...
              <div className="card-bottom bg-neutral ">
                ...
                <p className="font-serif text-center text-white hidden lg:block">
                  {data?.desc}
                </p>
              </div>
            </div>

  ...
  return (
    <Container>
      <div className="py-12">
        ...
        <div>
          <Description>Choose Region</Description>
          <DescriptionMobile>Choose Region</DescriptionMobile>
        ...
        <div className=" hidden lg:block">
          {selectedRegion && 
          <Description>Choose District</Description>
          }
          <Swiper
            loop={true}
            navigation={true}
        ...
        <div className="lg:hidden">
          ...
          {selectedRegion && <DescriptionMobile>Choose District</DescriptionMobile>}
          <Swiper
            loop={true}
            navigation={true}
            keyboard={true}
          ...
          >
            {selectedRegion?.district?.map((d, index) => (
              ...
              >
                <div>
                  <span className="mr-2 font-mono italic  border-r border-spacing-2  shadow-xl border-yellow-700 text-wrap text-sm font-bold ">
                    {d}
                  </span>
                </div>
              </SwiperSlide>
